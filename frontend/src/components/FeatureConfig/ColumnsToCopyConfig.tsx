...
export const ColumnsToCopyConfig: React.FC<ColumnsToCopyConfigProps> = ({
  ...
  const handleColumnConditionChange = (columnName: string, condition: string) => {
    const updatedColumns = {
      ...columnsToCopy,
      [columnName]: {
        ...columnsToCopy[columnName],
    ...
    <div className={fr.cx('fr-grid-row', 'fr-grid-row--gutters')}>
      <div className={fr.cx('fr-col-12')}>
        ...
        <p className={fr.cx('fr-text--sm', 'fr-mb-3w')}>
          Configurez quelles colonnes doivent être copiées depuis les amendements similaires trouvés.
        </p>
        ...
        {Object.entries(columnsToCopy).length === 0 ? (
          ...
          Object.entries(columnsToCopy).map(([columnName, config]) => (
            <div key={columnName} className={fr.cx('fr-mb-3w', 'fr-p-2w', 'fr-fieldset')}>
              <div className={fr.cx('fr-grid-row', 'fr-grid-row--gutters')}>
                    ...
                    options={[
                      {
                        ...
                        nativeInputProps: {
                          ...
                          onChange: (e) => handleColumnEnabledChange(columnName, e.target.checked),
                          disabled,
                        },
                      },
                    ]}
                  ...
                  <div className={fr.cx('fr-col-12', 'fr-col-md-6')}>
                    <Input
                      ...
                      nativeInputProps={{
                        ...
                        onChange: (e) => handleColumnConditionChange(columnName, e.target.value),
                        disabled,
                      }}
                    />
                  </div>
